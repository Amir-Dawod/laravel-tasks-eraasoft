                  ...
                  <ul id="menu" class="menu navbar-nav mx-auto">
                      <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="index.">Home 1</a>
                              <a class="dropdown-item" href="index-2">Home 2</a>
                              <a class="dropdown-item" href="index-3">Home 3</a>
                              <a class="dropdown-item" href="index-4">Home 4</a>
                              <a class="dropdown-item" href="index-5">Home 5</a>
                              <a class="dropdown-item" href="index-6">Home 6</a>
                          </div>
                      </li>
                      <li class="nav-item dropdown">
